...
export const AboutSection = () => {
  return (
    <section
      id="about"
      className="py-28 px-6 bg-gradient-to-br from-background to-muted/50 relative overflow-hidden"
    >
      <div className="container mx-auto max-w-6xl grid md:grid-cols-2 gap-20 items-center">
        ...
        >
          <div className="relative w-[350px] h-[350px] rounded-full p-[6px] bg-gradient-to-tr from-primary to-purple-600 shadow-2xl ">
            <img
              src={avatar}
              alt="Kalash Avatar"
        ...
        <div>
          ...
          >
            A B.Tech student and self-driven tech enthusiast who crafts beautiful, fast, and responsive web experiences using modern frameworks. I enjoy solving real-world problems through innovative UI/UX and collaborating with creative minds.
          </motion.p>
